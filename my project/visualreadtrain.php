...
<body>
    ...
    $query = "SELECT train_no, train_name, start_station, end_station, start_time, end_time FROM train WHERE train_no='$train_no';";
        ...
        <script>
            ...
            function readNext() 
            {
                ...
                const utterance = new SpeechSynthesisUtterance(
                    ...
                    to ${train.end_station}, starting at ${train.start_time} and arriving at ${train.end_time}...can I repeat once again?`
                );
                utterance.lang = "en-IN";
                speechSynthesis.speak(utterance);
                utterance.onend = () => startrecord();
            }
