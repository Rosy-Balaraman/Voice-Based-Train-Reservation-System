...
<body>
    ...
    if ($result->num_rows > 0) 
    {
        ...
        $query1 = "SELECT b.train_no, b.booking_id, t.train_name, t.start_station, t.end_station, b.journey_date, b.booking_status 
                    FROM booking b JOIN train t ON t.train_no = b.train_no WHERE booking_status = 'booked' AND p_id = '$p_id' ORDER BY journey_date;";
        ...
        {
            echo '<div class="error-message">No Ticket Booked</div>';
        }
    }
    else 
    {
