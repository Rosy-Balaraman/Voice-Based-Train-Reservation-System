...
<body>
    ...
    <?php        
     ...
     echo $p_id ;
      ...
      on t.train_no=b.train_no where booking_status = 'pending' AND p_id = '$p_id'  order by journey_date;";
...
{
    echo "<div id='no-trains'><center><strong>No train has been booked.</strong></center></div>";
    echo "<script>
