...
<body>
    ...
    <div class="container">
        <form action="" method="post">
            <input type="text" placeholder="Enter your PNR Number" name="pnr" required><br>
...
if (isset($_POST['cancel'])) 
{
    ...
    $pnr = $_POST['pnr'];
        ...
        $q1 =  "SELECT b.ref_id, b.train_no, b.compartment, b.journey_date, b.class, b.ticket_price, b.p_id, 
       (SELECT SUM(ticket_price) FROM booking WHERE booking_id = '$pnr') as total_price FROM booking b 
       WHERE b.booking_id = '$pnr';";
...
$r1 = mysqli_query($con, $q1);
        ...
        if ($r1->num_rows > 0) 
        {
            ...
            if (mysqli_query($con, $query0))
            {
                ...
                {
                        $qe="select ref_id from booking where booking_id='$pnr';";
                        ...
                        if ($re->num_rows > 0) 
                        {
                            ...
                            { 
                                $ref_id = $row["ref_id"];
                                $query5 = "DELETE FROM seat WHERE ref_id ='$ref_id';";  
            ...
            {
                echo "<div class='error'>PNR number not found.</div>";
            }
