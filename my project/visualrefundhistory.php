...
<body>
    ...
    <?php       
     ...
     echo $p_id ;
      ...
      on t.train_no=b.train_no where payment_status='refund' and p_id='$p_id' order by journey_date;";
        ...
        function readNext() 
        {
            if (index < trains.length)
            {
                ...
                const utterance = new SpeechSynthesisUtterance(
                    ...
                    to ${train.end_station}, starting at ${train.start_time} and arriving at ${train.end_time}, journey date is ${train.journey_date}, 
                    your PNR number is ${train.booking_id}.`);
...
{
    echo "<div id='no-trains'><center><strong>No ticket has been refunded.</strong></center></div>";
    echo "<script>
