...
if ($result->num_rows > 0) {
    ...
    $query1 = "SELECT b.train_no, b.booking_id, t.train_name, t.start_station, t.end_station, b.journey_date, b.booking_status FROM booking b 
                JOIN train t ON t.train_no = b.train_no WHERE payment_status = 'refund' AND p_id = '$p_id' ORDER BY journey_date;";
    ...
    if ($result1->num_rows > 0) {
        ...
        echo '<div class="error-message">No Tickets Have Been Refunded</div>';
    }
} else {
