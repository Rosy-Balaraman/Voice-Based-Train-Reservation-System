...
<body>
<?php 
        $query1 = "SELECT reward_points FROM rewards WHERE p_id='$p_id';";
    ...
    echo '<h2>Your Reward Points</h2>';
    echo '<div class="reward-points">' . $reward_points . ' Points</div>';
    ...
    function readwallet()
    {
            const utterance = new SpeechSynthesisUtterance(`Your Reward ponits is ${reward_points} points...can i repeat it`);
    ...
    function record()
    {
        ...
        rec.onresult = function(event) 
        {
            ...
            if (speechResult.includes("ok")||speechResult.includes("hmmmm")) 
            {
